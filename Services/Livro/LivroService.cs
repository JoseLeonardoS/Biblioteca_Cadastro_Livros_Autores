...
namespace Biblioteca.Services.Livro
{
    public class LivroService : ILivroInterface
    {
        ...
        public async Task<ResponseModel<LivroModel>> ListarLivroPorIdAutor(int idAutor)
        {
            ResponseModel<LivroModel> resposta = new ResponseModel<LivroModel>();
            try
            {
                var livro = await _context.Livros.Where(a => a.Autor.Id == idAutor).Include(a => a.Autor).FirstOrDefaultAsync();
        ...
        public async Task<ResponseModel<List<LivroModel>>> ListarLivros()
        {
            ...
            try
            {
                ...
                resposta.Mensagem = "Todos o livros foram coletados";
